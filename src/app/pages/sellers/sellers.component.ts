...
import { TableColumn, TableAction, ReusableTableComponent } from '../../shared/my-table/my-table.component';
...
export class SellersComponent {
  ...
  allUsers: any[] | undefined;
    ...
    columns: TableColumn[] = [
      { key: 'sellerName', label: 'Names', sortable: true },
      ...
      { key: 'sellerEmail', label: 'Email', sortable: true },
      { key: 'phoneNumber', label: 'Phone Number', sortable: false },
      { key: 'status', label: 'is Approved', sortable: false },
      { key: 'storeAddress', label: 'Store Address', sortable: false },
    ];
    ...
    blockUser(user: any): void {
      ...
      this.loading.show();
      this.fireService.updateDocument('sellers', user, { status: 'Blocked' }).then(() => {
    ...
    unblockUser(user: any): void {
      ...
      this.loading.show();
      this.fireService.updateDocument('sellers', user, { status: "approved" }).then(() => {
    ...
    disapproveSeller(user: any): void {
      ...
      this.loading.show();
      this.fireService.updateDocument('sellers', user, { status: "disapproved" }).then(() => {
